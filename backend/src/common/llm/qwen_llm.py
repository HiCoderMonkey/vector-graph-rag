...
from common.output_parsers.qwen_tools import (
  PydanticToolsParser as QwenPydanticToolsParser
)
...
class BaseChatQwenAI(BaseChatModel):
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        values["qwen_api_key"] = get_from_dict_or_env(values, "qwen_api_key", "QWEN_API_KEY")
        return values
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        payload = self._get_request_payload(messages, stop=stop, **kwargs)
        payload['request_timeout']=600
        logger.info(f'请求qwen:....')
        response = dashscope.Generation.call(**payload)
    ...
    def _create_chat_result(
        ...
        try:
            ...
            raise ValueError(f"Error parsing model output: {e}")
        ...
        **kwargs: Any,
        ...
        if method == "function_calling":
            ...
            if is_pydantic_schema:
                output_parser: OutputParserLike = QwenPydanticToolsParser(
...
class ChatQwenAI(BaseChatQwenAI):
